                    ...
                    <!-- Nested Row within Card Body -->
                            ...
                            <div class="p-2">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Edit Detail Transaksi</h1>
                                </div>
                                <form class="user" action="editdetailtransaksi.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label>Qty</label>
                                        <input type="text" class="form-control form-control-user" id="exampleInputUsername" name="txt_qty" value="<?php echo $qty; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label>Biaya</label>
                                        <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="txt_biaya" value="<?php echo $biaya; ?>" >
                                    </div>
                                    <div class="form-group">
                                        <label>Keterangan</label>
                                        <input type="text" class="form-control form-control-user" id="exampleInputPassword" name="txt_keterangan" value="<?php echo $keterangan; ?>">
                                    </div>
                                    ...
                                    <div class="form-group row" style="position: relative; float: right; ">
                                        ...
                                        <div style="width: 125px;">
                                            <a href="tdttransaksi.php" class="btn btn-secondary btn-user btn-block">Kembali</a>
                                        </div>
                                    </div>
                                </form>
