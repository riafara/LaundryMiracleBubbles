...
if( isset($_POST['update']) ){
    ...
    $query = "INSERT INTO tb_detail_transaksi (id_detail, id_transaksi, id_paket, qty, biaya, keterangan) VALUES ('$detail', '$transaksi', '$pkt', '$qty', '$biaya', '$keterangan')";
    echo $query;
            ...
            <div class="card-body w-75 vh-50 ">
                <!-- Nested Row within Card Body -->
                        ...
                        <div class="p-2">
                            ...
                            <form class="user" action="insertdtt.php" method="POST">
                                <div class="form-group">
                                    <label>ID Detail Transaksi</label>
                                    <input type="text" class="form-control form-control-user" id="exampleInputId"
                                        placeholder="ID Detail Transaksi" name="txt_id">
                                </div>
                                <div class="form-group">
                                    <label>ID Transaksi</label>
                                    <input type="text" class="form-control form-control-user" id="exampleInputIdt"
                                        placeholder="ID Transaksi" name="txt_idt">
                                </div>
                                <div class="form-group">
                                    <label>Paket</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="exampleInputKeterangan"
                                        placeholder="Keterangan" name="txt_keterangan">
                                </div>
                                <hr>
